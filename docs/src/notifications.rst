...
=====================
The ``tcex.notification()`` method has no required fields and just creates a local notification object.  As there are two main ways that notifications are used in ThreatConnect, there are 2 main methods and a send method.
