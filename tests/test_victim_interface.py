...
# def test_victim_create_assets():
#     victim_id = 4
#     victim = ti.write.victim(None, unique_id=victim_id)
#     response = victim.create_phone_asset('8675309')
#     assert response.json().get('status') == 'Success'
#
#     response = victim.create_website_asset('website_name')
#     assert response.json().get('status') == 'Success'
#
#     response = victim.create_email_asset('email_name', 'email_type')
#     assert response.json().get('status') == 'Success'
#
