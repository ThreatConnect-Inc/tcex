...
def adversary_create(batch_job):
    ...
    adversary = batch_job._group('Adversary', name, xid=xid)
...
def campaign_create(batch_job):
    ...
    campaign = batch_job._group('Campaign', name, xid=xid)
...
def document_create(batch_job):
    ...
    document = batch_job._group('Document', name, xid=xid)
...
def email_create(batch_job):
    ...
    email = batch_job._group('Email', name, xid=xid)
...
def event_create(batch_job):
    ...
    event = batch_job._group('Event', name, xid=xid)
...
def incident_create(batch_job):
    ...
    incident = batch_job._group('Incident', name, xid=xid)
...
def intrusion_set_create(batch_job):
    ...
    intrusion_set = batch_job._group('Intrusion Set', name, xid=xid)
...
def report_create(batch_job):
    ...
    report = batch_job._group('Report', name, xid=xid)
...
def signature_create(batch_job):
    ...
    signature = batch_job._group('Signature', name, xid=xid)
...
def threat_create(batch_job):
    ...
    threat = batch_job._group('Threat', name, xid=xid)
