...
class TestStringOperationsSnakeCase:
    """Test Suite"""
    ...
    def test_string_operations_snake_string(
        self,
        string: str,
        camel_case: str,
        pascal_case: str,
    ...
    def test_string_operations_snake_to_pascal(self, string: str, expected: str):
        """Test Case"""
    ...
    def test_string_operations_snake_to_camel(self, string: str, expected: str):
        """Test Case"""
