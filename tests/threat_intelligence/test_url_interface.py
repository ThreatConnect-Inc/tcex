...
class TestUrlIndicators(TestThreatIntelligence):
    ...
    def tests_ti_url_add_attribute(self, request):
    ...
    def tests_ti_url_add_tag(self, request):
    ...
    def tests_ti_url_get_includes(self, request):
        """Test indicator get with includes."""
        super().indicator_get_includes(request)

    def tests_ti_url_get_attribute(self, request):
    ...
    def tests_ti_url_get_tag(self, request):
