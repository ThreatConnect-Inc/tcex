...
class TestTacticGroups(TestThreatIntelligence):
    ...
    def tests_ti_tactic_add_attribute(self, request):
        """Test group add attribute."""
        super().group_add_attribute(request)

    def tests_ti_tactic_add_label(self):
        """Test group add label."""
        super().group_add_label()

    def tests_ti_tactic_add_tag(self, request):
        """Test group add tag."""
        super().group_add_tag(request)

    def tests_ti_tactic_delete(self):
        """Test group delete."""
        super().group_delete()

    def tests_ti_tactic_get(self):
        """Test group get with generic group method."""
        super().group_get()

    def tests_ti_tactic_get_filter(self):
        """Test group get with filter."""
        super().group_get_filter()

    def tests_ti_tactic_get_includes(self, request):
        """Test group get with includes."""
        super().group_get_includes(request)

    def tests_ti_tactic_get_attribute(self, request):
        """Test group get attribute."""
        super().group_get_attribute(request)

    def tests_ti_tactic_get_label(self):
        """Test group get label."""
        super().group_get_label()

    def tests_ti_tactic_get_tag(self, request):
        """Test group get tag."""
        super().group_get_tag(request)

    def tests_ti_tactic_update(self, request):
