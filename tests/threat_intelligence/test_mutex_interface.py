...
class TestMutexIndicators(TestThreatIntelligence):
    ...
    def tests_ti_mutex_create(self):
        ...
        ti = self.ti.mutex(**indicator_data)
        r = ti.create()
    ...
    def tests_ti_mutex_add_attribute(self, request):
    ...
    def tests_ti_mutex_get_includes(self, request):
        """Test indicator get with includes."""
        super().indicator_get_includes(request)

    def tests_ti_mutex_get_attribute(self, request):
    ...
    def tests_ti_mutex_get_tag(self, request):
