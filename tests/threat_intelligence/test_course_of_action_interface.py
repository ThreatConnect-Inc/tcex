...
class TestCourseOfActionGroups(TestThreatIntelligence):
    """Test TcEx Instrusion Set Groups."""

    group_type = 'Course of Action'
    ...
    def tests_ti_course_of_action_create(self):
        """Create a group using specific interface."""
        group_data = {
            'name': self.ti_helper.rand_name(),
            'owner': self.owner,
        }
        ti = self.ti.course_of_action(**group_data)
        r = ti.create()
    ...
    def tests_ti_course_of_action_add_attribute(self, request):
        """Test group add attribute."""
        super().group_add_attribute(request)

    def tests_ti_course_of_action_add_label(self):
        """Test group add label."""
        super().group_add_label()

    def tests_ti_course_of_action_add_tag(self, request):
        """Test group add tag."""
        super().group_add_tag(request)

    def tests_ti_course_of_action_delete(self):
        """Test group delete."""
        super().group_delete()

    def tests_ti_course_of_action_get(self):
        """Test group get with generic group method."""
        super().group_get()

    def tests_ti_course_of_action_get_filter(self):
        """Test group get with filter."""
        super().group_get_filter()

    def tests_ti_course_of_action_get_includes(self, request):
        """Test group get with includes."""
        super().group_get_includes(request)

    def tests_ti_course_of_action_get_attribute(self, request):
        """Test group get attribute."""
        super().group_get_attribute(request)

    def tests_ti_course_of_action_get_label(self):
        """Test group get label."""
        super().group_get_label()

    def tests_ti_course_of_action_get_tag(self, request):
        """Test group get tag."""
        super().group_get_tag(request)

    def tests_ti_course_of_action_update(self, request):
