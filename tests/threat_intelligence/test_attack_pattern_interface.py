...
class TestAttackPatternGroups(TestThreatIntelligence):
    """Test TcEx Instrusion Set Groups."""

    group_type = 'Attack Pattern'
    ...
    def tests_ti_attack_pattern_create(self):
        """Create a group using specific interface."""
        group_data = {
            'name': self.ti_helper.rand_name(),
            'owner': self.owner,
        }
        ti = self.ti.attack_pattern(**group_data)
        r = ti.create()
    ...
    def tests_ti_attack_pattern_add_attribute(self, request):
        """Test group add attribute."""
        super().group_add_attribute(request)

    def tests_ti_attack_pattern_add_label(self):
        """Test group add label."""
        super().group_add_label()

    def tests_ti_attack_pattern_add_tag(self, request):
        """Test group add tag."""
        super().group_add_tag(request)

    def tests_ti_attack_pattern_delete(self):
        """Test group delete."""
        super().group_delete()

    def tests_ti_attack_pattern_get(self):
        """Test group get with generic group method."""
        super().group_get()

    def tests_ti_attack_pattern_get_filter(self):
        """Test group get with filter."""
        super().group_get_filter()

    def tests_ti_attack_pattern_get_includes(self, request):
        """Test group get with includes."""
        super().group_get_includes(request)

    def tests_ti_attack_pattern_get_attribute(self, request):
        """Test group get attribute."""
        super().group_get_attribute(request)

    def tests_ti_attack_pattern_get_label(self):
        """Test group get label."""
        super().group_get_label()

    def tests_ti_attack_pattern_get_tag(self, request):
        """Test group get tag."""
