...
class TestAddressIndicators:
    ...
    def test_address_get_attributes(self, ip='11.21.31.41'):
        ...
        # create
        self.test_address_create(ip)
        self.test_address_add_attribute(ip, 'Description', 'test1')
        self.test_address_add_attribute(ip, 'Description', 'test2')
        self.test_address_add_attribute(ip, 'Description', 'test3')
    ...
    def test_address_get_tags(self, ip='13.23.33.43'):
        ...
        # create
        self.test_address_create(ip)
        self.test_address_add_tag(ip, 'One')
        self.test_address_add_tag(ip, 'Two')
    ...
    def test_address_get_include(self, ip='40.30.20.10'):
        """Test address get."""
        self.test_address_create(ip)
        self.test_address_add_attribute(ip, 'Description', 'test123')
        self.test_address_add_label(ip, 'TLP:RED')
        self.test_address_add_tag(ip, 'PyTest')
    ...
    def test_address_add_attribute(
        self, ip='12.13.14.15', attribute_type='Description', attribute_value='Example Description.'
    ):
    ...
    def test_address_add_label(self, ip='12.13.14.15', label='TLP:GREEN'):
        """Test address attribute add."""
        ti = self.ti.indicator(indicator_type='Address', ip=ip)
    ...
    def test_address_add_tag(self, ip='12.13.14.15', name='Crimeware'):
        """Test address attribute add."""
        ti = self.ti.indicator(indicator_type='Address', ip=ip)
    ...
    def test_address_delete(self, ip='12.11.12.11'):
        """Test address delete."""
        # create indicator
        self.test_address_create(ip)
