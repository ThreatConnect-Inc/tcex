...
class TestGroup2:
    ...
    def test_adversary(self, name, description, label, tag, tcex: TcEx):
        ...
        ti = cast(Group, batch.group(group_type='Adversary', name=name, xid=xid))
    ...
    def test_campaign(self, name, description, label, tag, tcex: TcEx):
        ...
        ti = cast(Group, batch.group(group_type='Campaign', name=name, xid=xid))
        ti.attribute(attr_type='Description', attr_value=description, displayed=True)
        ti.security_label(name=label, description='Pytest Label Description', color='ffc0cb')
        ti.tag(name=tag)
        batch.save(ti)
    ...
    def test_document(self, name, description, label, tag, tcex: TcEx):
        ...
        ti = cast(
            Group, batch.group(group_type='Document', name=name, file_name='example.txt', xid=xid)
        )
    ...
    def test_document_malware(self, name, description, label, tag, tcex: TcEx):
        ...
        xid = batch.generate_xid(['pytest', 'document', name])
        ti = cast(
            Group, batch.group(group_type='Document', name=name, file_name='example.zip', xid=xid)
        )
        ti.malware = True
        ti.password = 'test'
        ti.attribute(attr_type='Description', attr_value=description, displayed=True)
    ...
    def test_incident(self, name, description, label, tag, tcex: TcEx):
        ...
        ti = cast(Group, batch.group(group_type='Incident', name=name, xid=xid))
        ti.attribute(attr_type='Description', attr_value=description, displayed=True)
        ti.security_label(name=label, description='Pytest Label Description', color='ffc0cb')
        ti.tag(name=tag)
        batch.save(ti)
    ...
    def test_intrusion_set(self, name, description, label, tag, tcex: TcEx):
        ...
        ti = cast(Group, batch.group(group_type='Intrusion Set', name=name, xid=xid))
        ti.attribute(attr_type='Description', attr_value=description, displayed=True)
        ti.security_label(name=label, description='Pytest Label Description', color='ffc0cb')
        ti.tag(name=tag)
        batch.save(ti)
    ...
    def test_threat(self, name, description, label, tag, tcex: TcEx):
        ...
        ti = cast(Group, batch.group(group_type='Threat', name=name, xid=xid))
        ti.attribute(attr_type='Description', attr_value=description, displayed=True)
        ti.security_label(name=label, description='Pytest Label Description', color='ffc0cb')
        ti.tag(name=tag)
        batch.save(ti)
