...
class TestAsnIndicators(TestThreatIntelligence):
    ...
    def tests_ti_asn_create(self):
        ...
        ti = self.ti.asn(**indicator_data)  # type: ignore
        r = ti.create()
    ...
    def tests_ti_asn_add_attribute(self, request: FixtureRequest):
    ...
    def tests_ti_asn_add_tag(self, request: FixtureRequest):
    ...
    def tests_ti_asn_get_includes(self, request: FixtureRequest):
        """Test indicator get with includes."""
        super().indicator_get_includes(request)

    def tests_ti_asn_get_attribute(self, request: FixtureRequest):
    ...
    def tests_ti_asn_get_tag(self, request: FixtureRequest):
