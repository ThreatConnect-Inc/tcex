...
class TestIntrusionSetGroups(TestThreatIntelligence):
    ...
    def tests_ti_intrusion_set_add_attribute(self, request: FixtureRequest):
    ...
    def tests_ti_intrusion_set_add_tag(self, request: FixtureRequest):
        """Test group add tag."""
    ...
    def tests_ti_intrusion_set_get_includes(self, request: FixtureRequest):
        """Test group get with includes."""
        super().group_get_includes(request)

    def tests_ti_intrusion_set_get_attribute(self, request: FixtureRequest):
        """Test group get attribute."""
        super().group_get_attribute(request)

    def tests_ti_intrusion_set_get_label(self):
        """Test group get label."""
        super().group_get_label()

    def tests_ti_intrusion_set_get_tag(self, request: FixtureRequest):
        """Test group get tag."""
        super().group_get_tag(request)

    def tests_ti_intrusion_set_update(self, request: FixtureRequest):
