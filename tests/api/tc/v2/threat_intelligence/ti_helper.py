...
class TIHelper:
    ...
    def create_group(self, **kwargs) -> Group:
        ...
        Args:
            ...
            kwargs: Additional keyword arguments to pass to the group method.
        """
    ...
    def create_indicator(self, indicator_type=None, **kwargs) -> Indicator:
        ...
        Args:
            ...
            kwargs: Additional keyword arguments to pass to the indicator method.
        """
...
class TestThreatIntelligence:
    ...
    def group_add_attribute(self, request: FixtureRequest):
    ...
    def group_add_tag(self, request: FixtureRequest):
    ...
    def group_get_includes(self, request: FixtureRequest):
    ...
    def group_get_attribute(self, request: FixtureRequest):
    ...
    def group_get_tag(self, request: FixtureRequest):
        """Get tags for an group."""
        tag_data = {'name': request.node.name}
    ...
    def group_update(self, request: FixtureRequest):
    ...
    def indicator_add_attribute(self, request: FixtureRequest):
    ...
    def indicator_add_tag(self, request: FixtureRequest):
    ...
    def indicator_get_includes(self, request: FixtureRequest):
    ...
    def indicator_get_attribute(self, request: FixtureRequest):
    ...
    def indicator_get_tag(self, request: FixtureRequest):
        """Get tags for an indicator."""
        tag_data = {'name': request.node.name}
