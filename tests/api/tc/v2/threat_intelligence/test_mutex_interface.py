...
class TestMutexIndicators(TestThreatIntelligence):
    ...
    def tests_ti_mutex_create(self):
        ...
        indicator_data = {
            self.indicator_field_arg: self.ti_helper.rand_mutex(),
    ...
    def tests_ti_mutex_add_attribute(self, request: FixtureRequest):
        """Test indicator add attribute."""
        super().indicator_add_attribute(request)

    def tests_ti_mutex_add_label(self):
        """Test indicator add label."""
        super().indicator_add_label()

    def tests_ti_mutex_add_tag(self, request: FixtureRequest):
