...
class TestUserAgentIndicators(TestThreatIntelligence):
    ...
    def tests_ti_user_agent_add_attribute(self, request: FixtureRequest):
    ...
    def tests_ti_user_agent_add_tag(self, request: FixtureRequest):
    ...
    def tests_ti_user_agent_get_includes(self, request: FixtureRequest):
        """Test indicator get with includes."""
        super().indicator_get_includes(request)

    def tests_ti_user_agent_get_attribute(self, request: FixtureRequest):
    ...
    def tests_ti_user_agent_get_tag(self, request: FixtureRequest):
