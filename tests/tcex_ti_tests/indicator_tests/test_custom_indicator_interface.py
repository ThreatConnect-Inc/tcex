...
current_dir = sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '.')))
parent = sys.path.append(os.path.abspath('indicator_tests'))
parent_parent = sys.path.append(os.path.abspath('tcex_ti_tests'))
