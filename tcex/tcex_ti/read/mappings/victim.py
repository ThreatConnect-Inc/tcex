...
class Victim(TIMappings):
    def __init__(self, tcex, name, **kwargs):
        super(Victim, self).__init__(tcex, 'Victim', **kwargs)
        self._data['type'] = 'victims'
    ...
    def asset(self, asset_type, name, type=None, id=None, action='CREATE'):
        return self._tc_requests._victim_asset(self._data, asset_type, name, type=type, id=id, action=action)
