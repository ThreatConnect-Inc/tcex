...
class Document(Group):
    ...
    def __init__(self, tcex, file_name):
        ...
        """
        super(Document, self).__init__(tcex, 'documents')
    ...
    def file_content(self, file_content, update_if_exists=True):
        ...
        return self.tc_requests.upload(self.type, self.api_sub_type, self.unique_id, request)
