...
class TcExPlaybook(object):
    ...
    def __init__(self, tcex):
        ...
        Intialize parent class for default values and logging method.
        """
        self._tcex = tcex
        ...
        if self._tcex._args.tc_playbook_db_type == 'Redis':
            try:
                ...
                self._tcex.log.error('Redis Module is not installed.')
                raise
    ...
    def check_output_variable(self, variable):
        ...
        Using the autogenerated dictionary of output variables check to see if provided
    ...
    def entity_to_bulk(entities, resource_type_parent):
        ...
        Args:
            ...
            value_field (string): Field names that "value" should be converted.
            resource_type_parent (string): The resoure parent type of the tc_data provided.
        ...
        for e in entities:
            bulk = {}
            bulk['type'] = e.get('type')
            bulk['ownerName'] = e.get('ownerName')
    ...
    def json_to_bulk(tc_data, value_fields, resource_type, resource_type_parent):
        ...
        Args:
            ...
            resource_type (string): The resoure type of the tc_data provided.
            resource_type_parent (string): The resoure parent type of the tc_data provided.
    ...
    def json_to_key_value(json_data, key_field, value_field=None, array=False):
        ...
        for d in json_data:
            if d.get(key_field) is not None and value_field is None:
                ...
                # key / value data are from seperate entries
                key = d.get(key_field)
