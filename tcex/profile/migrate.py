...
class Migrate:
    ...
    def add_staging_data(self, profile_data: dict, name: str, type_: str, value: str) -> str:
        """Create staging data and return variable value.

        Args:
            profile_data: The profile to update with new staging data.
    ...
    @staticmethod
    def comment_to_comments(profile_data: dict) -> None:
    ...
    def move_default_inputs(self, profile_data: dict) -> None:
    ...
    @staticmethod
    def permutation_output_variables(profile_data: dict) -> None:
    ...
    def service_config_inputs(self, profile_data: dict) -> None:
    ...
    @staticmethod
    def create_staged_section(profile_data: dict) -> None:
    ...
    @staticmethod
    def stage_redis_name(profile_data: dict) -> None:
        ...
        Args:
            profile_data: The current profile data dict.
    ...
    def stage_threatconnect_data(profile_data: dict) -> None:
        ...
        stage_tc: Optional[dict] = profile_data.get('stage', {}).get('threatconnect')
    ...
    @staticmethod
    def variable_pattern_env_v2(profile_data: dict) -> dict:
        """Update the profile variable to latest pattern
    ...
    def variable_pattern_tcenv(self, profile_data: dict) -> dict:
        """Update the profile variable to latest pattern
