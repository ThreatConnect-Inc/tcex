"""Workflow Event / Workflow Events Model"""
# standard library
...
class WorkflowEventModel(
    ...
    case_id: Optional[int] = Field(
        None,
        description='The **case id** for the Workflow Event.',
        methods=['POST'],
        read_only=False,
    ...
    case_xid: Optional[str] = Field(
        None,
        description='The **case xid** for the Workflow Event.',
        methods=['POST'],
        read_only=False,
    ...
    date_added: Optional[datetime] = Field(
        ...
        description='The **date added** for the Workflow Event.',
        read_only=True,
        title='dateAdded',
    )
    deleted: bool = Field(
        None,
        allow_mutation=False,
        description='The **deleted** for the Workflow Event.',
        read_only=True,
        title='deleted',
    )
    ...
    link: Optional[str] = Field(
        None,
        allow_mutation=False,
        description='The **link** for the Workflow Event.',
        read_only=True,
        title='link',
    )
    link_text: Optional[str] = Field(
        None,
        allow_mutation=False,
        description='The **link text** for the Workflow Event.',
        read_only=True,
        title='linkText',
    )
    ...
    parent_case: Optional['CaseModel'] = Field(
        None,
        allow_mutation=False,
        description='The **parent case** for the Workflow Event.',
        read_only=True,
        title='parentCase',
    )
    summary: Optional[str] = Field(
        None,
        description='The **summary** for the Workflow Event.',
        methods=['POST', 'PUT'],
        max_length=255,
        min_length=1,
        read_only=False,
    ...
    system_generated: bool = Field(
        None,
        allow_mutation=False,
        description='The **system generated** for the Workflow Event.',
        read_only=True,
    ...
    user: Optional['UserModel'] = Field(
        None,
        allow_mutation=False,
        description='The **user** for the Workflow Event.',
        read_only=True,
        title='user',
    )
...
# first-party
from tcex.api.tc.v3.cases.model import CaseModel
