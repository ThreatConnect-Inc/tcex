...
class ApiEndpoints(Enum):
    ...
    # INTEL_REQUIREMENTS_CATEGORIES = '/v3/intelRequirements/categories'
    # INTEL_REQUIREMENTS_RESULTS = '/v3/intelRequirements/results'
    # INTEL_REQUIREMENTS_SUBTYPES = '/v3/intelRequirements/subtypes'
