...
class SecurityLabelFilter(FilterABC):
    ...
    def color(self, operator: Enum, color: str) -> None:
        ...
        """
        self._tql.add_filter('color', operator, color, TQL.Type.STRING)
    ...
    def dateadded(self, operator: Enum, dateadded: str) -> None:
        ...
        """
        self._tql.add_filter('dateadded', operator, dateadded, TQL.Type.STRING)
    ...
    def hasgroup(self, operator: Enum, hasgroup: int) -> None:
        ...
        """
        self._tql.add_filter('hasgroup', operator, hasgroup, TQL.Type.INTEGER)
    ...
    def hasgroupattribute(self, operator: Enum, hasgroupattribute: int) -> None:
        ...
        """
        self._tql.add_filter('hasgroupattribute', operator, hasgroupattribute, TQL.Type.INTEGER)
    ...
    def hasindicator(self, operator: Enum, hasindicator: int) -> None:
        ...
        """
        self._tql.add_filter('hasindicator', operator, hasindicator, TQL.Type.INTEGER)
    ...
    def hasindicatorattribute(self, operator: Enum, hasindicatorattribute: int) -> None:
        ...
        """
        self._tql.add_filter('hasindicatorattribute', operator, hasindicatorattribute, TQL.Type.INTEGER)
    ...
    def hasvictim(self, operator: Enum, hasvictim: int) -> None:
        ...
        """
        self._tql.add_filter('hasvictim', operator, hasvictim, TQL.Type.INTEGER)
    ...
    def hasvictimattribute(self, operator: Enum, hasvictimattribute: int) -> None:
        ...
        """
        self._tql.add_filter('hasvictimattribute', operator, hasvictimattribute, TQL.Type.INTEGER)
    ...
    def hasworkflowattribute(self, operator: Enum, hasworkflowattribute: int) -> None:
        ...
        """
        self._tql.add_filter('hasworkflowattribute', operator, hasworkflowattribute, TQL.Type.INTEGER)
    ...
    def ownername(self, operator: Enum, ownername: str) -> None:
        ...
        """
        self._tql.add_filter('ownername', operator, ownername, TQL.Type.STRING)
