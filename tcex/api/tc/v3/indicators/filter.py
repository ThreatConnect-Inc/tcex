...
class IndicatorFilter(FilterABC):
    ...
    def active_locked(self, operator: Enum, active_locked: bool) -> None:
        ...
        """
        self._tql.add_filter('activeLocked', operator, active_locked, TQL.Type.BOOLEAN)
    ...
    def address_asn(self, operator: Enum, address_asn: int) -> None:
        ...
        """
        self._tql.add_filter('addressAsn', operator, address_asn, TQL.Type.INTEGER)
    ...
    def address_cidr(self, operator: Enum, address_cidr: str) -> None:
        ...
        """
        self._tql.add_filter('addressCidr', operator, address_cidr, TQL.Type.STRING)
    ...
    def address_city(self, operator: Enum, address_city: str) -> None:
        ...
        """
        self._tql.add_filter('addressCity', operator, address_city, TQL.Type.STRING)
    ...
    def address_countrycode(self, operator: Enum, address_countrycode: str) -> None:
        ...
        """
        self._tql.add_filter('addressCountrycode', operator, address_countrycode, TQL.Type.STRING)
    ...
    def address_countryname(self, operator: Enum, address_countryname: str) -> None:
        ...
        """
        self._tql.add_filter('addressCountryname', operator, address_countryname, TQL.Type.STRING)
    ...
    def address_ipval(self, operator: Enum, address_ipval: str) -> None:
        ...
        """
        self._tql.add_filter('addressIpval', operator, address_ipval, TQL.Type.STRING)
    ...
    def address_is_ipv6(self, operator: Enum, address_is_ipv6: bool) -> None:
        ...
        """
        self._tql.add_filter('addressIsIpv6', operator, address_is_ipv6, TQL.Type.BOOLEAN)
    ...
    def address_registeringorg(self, operator: Enum, address_registeringorg: str) -> None:
        ...
        """
        self._tql.add_filter('addressRegisteringorg', operator, address_registeringorg, TQL.Type.STRING)
    ...
    def address_state(self, operator: Enum, address_state: str) -> None:
        ...
        """
        self._tql.add_filter('addressState', operator, address_state, TQL.Type.STRING)
    ...
    def address_timezone(self, operator: Enum, address_timezone: str) -> None:
        ...
        """
        self._tql.add_filter('addressTimezone', operator, address_timezone, TQL.Type.STRING)
    ...
    def confidence(self, operator: Enum, confidence: int) -> None:
        ...
        """
        self._tql.add_filter('confidence', operator, confidence, TQL.Type.INTEGER)
    ...
    def false_positive_count(self, operator: Enum, false_positive_count: int) -> None:
        ...
        Args:
            operator: The operator enum for the filter.
            false_positive_count: The number of times the indicator has been flagged as a false positive.
        """
        self._tql.add_filter('falsePositiveCount', operator, false_positive_count, TQL.Type.INTEGER)
    ...
    def filename(self, operator: Enum, filename: str) -> None:
        ...
        """
        self._tql.add_filter('filename', operator, filename, TQL.Type.STRING)
    ...
    def fileoccurrence_date(self, operator: Enum, fileoccurrence_date: str) -> None:
        ...
        """
        self._tql.add_filter('fileoccurrenceDate', operator, fileoccurrence_date, TQL.Type.STRING)
    ...
    def filepath(self, operator: Enum, filepath: str) -> None:
        ...
        """
        self._tql.add_filter('filepath', operator, filepath, TQL.Type.STRING)
    ...
    def filesize(self, operator: Enum, filesize: str) -> None:
        ...
        """
        self._tql.add_filter('filesize', operator, filesize, TQL.Type.STRING)
    ...
    def flag1(self, operator: Enum, flag1: bool) -> None:
        ...
        Args:
            ...
            flag1: None.
        """
        self._tql.add_filter('flag1', operator, flag1, TQL.Type.BOOLEAN)
    ...
    def flag2(self, operator: Enum, flag2: bool) -> None:
        ...
        Args:
            ...
            flag2: None.
        """
        self._tql.add_filter('flag2', operator, flag2, TQL.Type.BOOLEAN)
    ...
    def flag3(self, operator: Enum, flag3: bool) -> None:
        ...
        Args:
            ...
            flag3: None.
        """
        self._tql.add_filter('flag3', operator, flag3, TQL.Type.BOOLEAN)
    ...
    def host_dns_active(self, operator: Enum, host_dns_active: bool) -> None:
        ...
        """
        self._tql.add_filter('hostDnsActive', operator, host_dns_active, TQL.Type.BOOLEAN)
    ...
    def host_whois_active(self, operator: Enum, host_whois_active: bool) -> None:
        ...
        """
        self._tql.add_filter('hostWhoisActive', operator, host_whois_active, TQL.Type.BOOLEAN)
    ...
    def int_value1(self, operator: Enum, int_value1: str) -> None:
        ...
        Args:
            ...
            int_value1: None.
        """
        self._tql.add_filter('intValue1', operator, int_value1, TQL.Type.STRING)
    ...
    def int_value2(self, operator: Enum, int_value2: str) -> None:
        ...
        Args:
            ...
            int_value2: None.
        """
        self._tql.add_filter('intValue2', operator, int_value2, TQL.Type.STRING)
    ...
    def int_value3(self, operator: Enum, int_value3: str) -> None:
        ...
        Args:
            ...
            int_value3: None.
        """
        self._tql.add_filter('intValue3', operator, int_value3, TQL.Type.STRING)
    ...
    def last_false_positive(self, operator: Enum, last_false_positive: str) -> None:
        ...
        """
        self._tql.add_filter('lastFalsePositive', operator, last_false_positive, TQL.Type.STRING)
    ...
    def last_observed(self, operator: Enum, last_observed: str) -> None:
        ...
        """
        self._tql.add_filter('lastObserved', operator, last_observed, TQL.Type.STRING)
    ...
    def observation_count(self, operator: Enum, observation_count: int) -> None:
        ...
        """
        self._tql.add_filter('observationCount', operator, observation_count, TQL.Type.INTEGER)
    ...
    def rating(self, operator: Enum, rating: int) -> None:
        ...
        """
        self._tql.add_filter('rating', operator, rating, TQL.Type.INTEGER)
    ...
    def threat_assess_score(self, operator: Enum, threat_assess_score: int) -> None:
        ...
        """
        self._tql.add_filter('threatAssessScore', operator, threat_assess_score, TQL.Type.INTEGER)
    ...
    def value1(self, operator: Enum, value1: str) -> None:
        ...
        Args:
            ...
            value1: None.
        """
        self._tql.add_filter('value1', operator, value1, TQL.Type.STRING)
    ...
    def value2(self, operator: Enum, value2: str) -> None:
        ...
        Args:
            ...
            value2: None.
        """
        self._tql.add_filter('value2', operator, value2, TQL.Type.STRING)
    ...
    def value3(self, operator: Enum, value3: str) -> None:
        ...
        Args:
            ...
            value3: None.
        """
        self._tql.add_filter('value3', operator, value3, TQL.Type.STRING)
