...
class ObjectTypes(str, Enum):
    ...
    # intel_requirements_categories = 'intel_requirements_categories'
    # intel_requirements_results = 'intel_requirements_results'
    # intel_requirements_subtypes = 'intel_requirements_subtypes'
