...
class CasesModel(
    ...
    data: 'Optional[List[CaseModel]]' = Field(
        [],
        description='The data for the Case.',
        methods=['POST', 'PUT'],
        title='data',
    )
...
class CaseModel(
    ...
    name: Optional[str] = Field(
        None,
        description='The **name** for the Case.',
        methods=['POST', 'PUT'],
        max_length=255,
        min_length=1,
        read_only=False,
    ...
    resolution: Optional[str] = Field(
        None,
        description='The **resolution** for the Case.',
        methods=['POST', 'PUT'],
        read_only=False,
        title='resolution',
    )
    severity: Optional[str] = Field(
        None,
        description='The **severity** for the Case.',
        methods=['POST', 'PUT'],
        read_only=False,
        title='severity',
    )
    status: Optional[str] = Field(
        None,
        description='The **status** for the Case.',
        methods=['POST', 'PUT'],
        read_only=False,
        title='status',
    )
