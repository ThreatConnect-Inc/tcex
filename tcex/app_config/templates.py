...
class CustomTemplates(TemplateBase):
    ...
    def custom_py(self):
        ...
        variables = {'runtime_level': self.profile.ij.data.runtime_level.lower()}
...
class DownloadTemplates(TemplateBase):
    ...
    def init_external(self, template: str):
        ...
        self.download_file(
            f'{self.url}/external/external_app.py',
            destination='external_app.py',
            overwrite=True,
        )
    ...
    def init_playbook(self):
        ...
        self.download_file(f'{self.url}/__main__.py', destination='__main__.py', overwrite=True)
        self.download_file(
            f'{self.url}/playbook/playbook_app.py',
            destination='playbook_app.py',
            overwrite=True,
        )
...
class TestProfileTemplates(TemplateBase):
    ...
    def app_class(self) -> str:
        ...
        return app_type_to_class.get(self.profile.ij.data.runtime_level.lower())
    ...
    def test_profiles_py(self):
        ...
        variables = {
            ...
            'runtime_level': self.profile.ij.data.runtime_level.lower(),
        }
...
class ValidationTemplates(TemplateBase):
    ...
    def validate_py(self):
        ...
        variables = {
            ...
            'output_data': self.output_data(self.profile.ij.data.tc_playbook_out_variables),
        }
